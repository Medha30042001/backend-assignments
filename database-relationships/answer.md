...
Here, customer_id in the orders table is referencing to the customer from customers table. One customer can be found in multiple columns in the order table.
